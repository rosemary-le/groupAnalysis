...
%     'r_V4_fVp_001_nw.mat'
% %     'r_ventral_fVp_nw.mat'
% % %     % places ventral
% % %     'l_cos_pVf_001_nw.mat'
% %     'r_cos_pVf_001_nw.mat'
% %     'rVO1_all_and_pVf_001_nw.mat';
% % 'rVO2_all_and_pVf_001_nw.mat';
% % 'rPHC1_all_and_pVf_001_nw.mat';
% % 'rPHC2_all_and_pVf_001_nw.mat';
% % 'r_antHIPPanatXcospvf_nw.mat'
% 
% 
...
% 'rV2_all_nw.mat';
% 'rV2_all_nw.Prosos.mat';
% 'rV3_all_nw.mat';
% 'rV3_all_nw.Prosos.mat';
    };
...
%     flip the x values in the rm struct
    for i=1:length(rm)
        rm{i}.x0=-1*rm{i}.x0;
%        flip phase angle by recomputing theta
        [rm{i}.theta ecc] = cart2pol(rm{i}.x0,rm{i}.y0);
    end
%     save with new name

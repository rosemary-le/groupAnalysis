...
function   f_makeBoxPlotsAcrossROIsCvsP(h,rois,controlMedians,prosoMedians,stats,fldname)
...
ROIdata = nan([length(h.sessions)*2, length(rois)*2]);
...
xpos = 1.5:3:x(end);
set(gca,'XTick',xpos,'XTickLabel',rois(:,3),'FontSize',18,'FontWeight','bold');

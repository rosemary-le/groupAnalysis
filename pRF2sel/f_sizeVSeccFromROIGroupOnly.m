function [rm models] = f_sizeVSeccFromROIGroupOnly(rm, h)
...
% what plots do we want from this?  at the moment it does too many
% different things and would be nice to separate into discrete functions

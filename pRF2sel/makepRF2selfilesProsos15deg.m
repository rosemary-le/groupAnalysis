...
% 'both_PHCanatXcospvf_all_nw'
% 'both_VOanatXcospvf_all_nw'
% 'l_antHIPPanatXcospvf_all_nw'
% 'l_PHCanatXcospvf_all_nw'
% 'l_VOanatXcospvf_all_nw'
% 'r_antHIPPanatXcospvf_all_nw'
% 'r_PHCanatXcospvf_all_nw'
% 'r_VOanatXcospvf_all_nw'

% 'both_ffa_fVp_001_nw.mat'
...
for r = 1:length(rois)
    roi=rois{r};
    pRF2sel;
    save([savedir roi  '.Prosos.mat' ], 'rm', 'ECCmv', 'mv');
    % clear all

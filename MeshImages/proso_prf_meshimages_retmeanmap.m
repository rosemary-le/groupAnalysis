...
% input.blockdir = '/Volumes/biac4-kgs/Projects/Prosopagnosia/fMRIData/';
input.blockdir = '/biac4/kgs/biac2/kgs/projects/Prosopagnosia/fMRIData/';
...
%'facesVSplaces01'; faces vs place contrast
   % 'anat'    anatomy
    ...
    % 'ph'    is polar angle
    % 'map'   is eccentricity
% 'ipsi cov map' is ipsilateral field coverage clipped at 0 degrees
    
    
% map name for figures
% and/or name of parametermap
% input.map = 'categoryVeccentricityPHCO.mat';
input.map = 'ret scans mean';
...
% input.savepath = ...
%     '/Volumes/biac4-kgs/Projects/retinotopy/adult_ecc_karen/Analyses/MeshImages/prf_meanmapsProsos/';
input.savepath = ...
    '/biac4/kgs/biac3/kgs4/projects/retinotopy/adult_ecc_karen/Analyses/MeshImages/prf_meanmapsProsos/';
% 
...
% end
    %if it does make sure yo

% % 
input.roi = {
    'rV1_all_nw', 'rV2d_all_nw', 'rV2v_all_nw', 'rV3v_all_nw', 'rV3d_all_nw',...%confluent ret
    'rLO1_all_nw', 'rLO2_all_nw','rTO1_all_nw','rTO2_all_nw',...%lateral ret
    'rV3ab_all_nw','rIPS0_all_nw',...%'rIPS1_nw','rIPS2_nw','rIPS3_nw','rIPS4_nw','rIPS5_nw','rIPS6_nw',...%dorsal ret
    'rV4_all_nw', 'rVO1_all_nw', 'rVO2_all_nw', 'rPHC1_all_nw', 'rPHC2_all_nw',...%ventral ret
    'r_cos_pVf_001_nw',... %ventral place rois
     'r_V4_fVp_001_nw', 'r_pfus_fVp_001_nw', 'r_mfus_fVp_001_nw','r_afus_fVp_001_nw'%ventral face rois
   };
% 
%     ...%   'allretmaps_mask' ... 
...
% % 
input.roi = {
    'lV1_all_nw', 'lV2d_all_nw', 'lV2v_all_nw', 'lV3v_all_nw', 'lV3d_all_nw', ...%confluent ret
    'lLO1_all_nw', 'lLO2_all_nw','lTO1_all_nw','lTO2_all_nw',...%lateral ret
    'lV3ab_all_nw','lIPS0_all_nw',...%'lIPS1_nw','lIPS2_nw','lIPS3_nw','lIPS4_nw','lIPS5_nw','lIPS6_nw',...%dorsal ret
    'lV4_all_nw', 'lVO1_all_nw', 'lVO2_all_nw', 'lPHC1_all_nw', 'lPHC2_all_nw',...%ventral ret%   'allretmaps_mask' ... %     'l_posthipp',... %hippocampal line
    'l_cos_pVf_001_nw',... %ventral place rois
     'l_V4_fVp_001_nw', 'l_pfus_fVp_001_nw', 'l_mfus_fVp_001_nw','l_afus_fVp_001_nw'%ventral face rois
   };

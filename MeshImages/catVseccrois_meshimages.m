...
% set roi drawing method will default to perimeter
...
% input.blockdir
% ='/Volumes/biac4-kgs/Projects/retinotopy/adult_ecc_karen/';
...
% input.savepath = ...
%   '/Volumes/biac4-kgs/Projects/retinotopy/adult_ecc_karen/Analyses/MeshImages/allrois/';
...
makeTiffsFromMeshImages(adult_rois_rven,input,'Right','facesVobjectsnohipp');
...
makeTiffsFromMeshImages(adult_rois_lven,input,'Left','facesVobjectsnohipp');
% makeTiffsFromMeshImages(adult_rois_lven,input,'Left','placesVfaces');


save([num2str(length(adult_sessions)) 'fVpROIs_nohipp' input.map '_' ...

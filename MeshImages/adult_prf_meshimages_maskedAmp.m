...
addpath('~/projects/retinotopy/adult_ecc_karen/Analyses/MeshImages');
...
input.blockdir = '~/projects/retinotopy/adult_ecc_karen/';
...
input.savepath = ...
    '/biac4/kgs/biac3/kgs4/projects/retinotopy/adult_ecc_karen/Analyses/MeshImages/prfAmp_allcontrolsBtoRcolor/';

if ~exist(input.savepath)
